#!/usr/bin/env python3
"""
Recupero codici sconto Bulk da shopilo.it
Sursa: https://shopilo.it/negozi/bulk.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/bulk.com"
STORE_NAME = "Bulk"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Bulk da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-bulk)"
    }
    try:
