 ...
 * Homepage: https://shopilo.it/negozi/bulk.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/bulk.com";
const STORE_NAME  = "Bulk";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-bulk)" }
  });
